  ...
  return (
    <section id="experience" className="py-20">
      <h1 className="heading">
        {t.experience.heading} <span className="text-purple">{t.experience.headingHighlight}</span>
      </h1>
            ...
            <div className="flex flex-col gap-2 p-3 py-6 md:p-5 lg:flex-row lg:items-center lg:p-10">
              ...
              <div className="lg:ms-5">
                <h1 className="text-start text-xl font-bold md:text-2xl">
                  {t.experience.titles[experience.title as keyof typeof t.experience.titles] || experience.title}
                </h1>
