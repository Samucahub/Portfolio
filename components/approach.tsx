  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        {t.approach.heading} <span className="text-purple">{t.approach.headingHighlight}</span>
      </h1>

      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          title={t.approach.phase1Title}
          icon={<MagicButton title={`${t.approach.phaseLabel} 1`} asChild />}
          description={t.approach.phase1Desc}
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          icon={<MagicButton title={`${t.approach.phaseLabel} 2`} asChild />}
          description={t.approach.phase2Desc}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          icon={<MagicButton title={`${t.approach.phaseLabel} 3`} asChild />}
          description={t.approach.phase3Desc}
        >
          <CanvasRevealEffect
            animationSpeed={3}
