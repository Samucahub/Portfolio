  ...
  return (
    <footer id="contact" className="mb-[100px] w-full pb-10 md:mb-auto">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading px-4 text-center md:px-0 lg:max-w-[45vw]">
          {t.footer.heading1} <span className="text-purple">{t.footer.headingHighlight}</span> {t.footer.heading2}
        </h1>
